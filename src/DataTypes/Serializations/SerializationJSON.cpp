...
SerializationJSON<Parser>::SerializationJSON(
    ...
    : SerializationObject(std::move(typed_paths_serializations_), paths_to_skip_, path_regexps_to_skip_, paths_shared_only_, path_regexps_shared_only_, dynamic_type_)
